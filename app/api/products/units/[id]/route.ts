...
export async function PUT(
  ...
  try {
    ...
    console.log(`🔄 [PUT /api/products/units] 更新单位: ${unitId} -> ${newUnit}`)
    ...
    console.log(`✅ [PUT /api/products/units] 单位更新成功: ${unitId} -> ${newUnitName}，影响 ${updateResult.count} 个产品`)
    ...
    console.error("❌ [PUT /api/products/units] 更新单位失败:", error)
    return NextResponse.json({
...
export async function DELETE(
  ...
  try {
    ...
    console.log(`🔄 [DELETE /api/products/units] 删除单位: ${unitId}`)
    ...
    console.log(`✅ [DELETE /api/products/units] 单位删除成功: ${unitId}`)
