...
ALTER TABLE public."AnnouncementRead_id_seq" OWNER TO postgres;
...
CREATE TABLE public."Artwork" (
    ...
    type text DEFAULT 'artwork'::text NOT NULL,
...
--
-- Name: ArtworkCategory; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."ArtworkCategory" (
    id integer NOT NULL,
    name text NOT NULL,
    code text,
    description text,
...
ALTER TABLE public."ArtworkCategory" OWNER TO postgres;

--
-- Name: ArtworkCategory_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."ArtworkCategory_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."ArtworkCategory_id_seq" OWNER TO postgres;

--
-- Name: ArtworkCategory_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."ArtworkCategory_id_seq" OWNED BY public."ArtworkCategory".id;


--
-- Name: ArtworkTag; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."ArtworkTag" (
    id integer NOT NULL,
    name text NOT NULL,
    color text,
    description text,
...
ALTER TABLE public."ArtworkTag" OWNER TO postgres;

--
-- Name: ArtworkTag_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."ArtworkTag_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."ArtworkTag_id_seq" OWNER TO postgres;

--
-- Name: ArtworkTag_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."ArtworkTag_id_seq" OWNED BY public."ArtworkTag".id;


--
-- Name: ArtworkTagsOnArtworks; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."ArtworkTagsOnArtworks" (
    "artworkId" integer NOT NULL,
    "tagId" integer NOT NULL
);


ALTER TABLE public."ArtworkTagsOnArtworks" OWNER TO postgres;
...
--
-- Name: Artwork_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
ALTER TABLE public."ChannelDeposit_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ChannelDistribution_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ChannelInventory_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ChannelInvoice_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ChannelPrice_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ChannelSaleItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ChannelSale_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ChannelSettlement_id_seq" OWNER TO postgres;
...
ALTER TABLE public."CoffeeShopItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."CoffeeShopPurchase_id_seq" OWNER TO postgres;
...
ALTER TABLE public."CoffeeShopSale_id_seq" OWNER TO postgres;
...
ALTER TABLE public."CoffeeShopShift_id_seq" OWNER TO postgres;
...
ALTER TABLE public."CompanyProfile_id_seq" OWNER TO postgres;
...
ALTER TABLE public."DataBackup_id_seq" OWNER TO postgres;
...
ALTER TABLE public."DataDictionaryItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."DataDictionary_id_seq" OWNER TO postgres;
...
ALTER TABLE public."DataTemplate_id_seq" OWNER TO postgres;
...
--
-- Name: FinanceRecord; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."FinanceRecord" OWNER TO postgres;

--
-- Name: FinanceRecord_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."FinanceRecord_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."FinanceRecord_id_seq" OWNER TO postgres;

--
-- Name: FinanceRecord_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."FinanceRecord_id_seq" OWNED BY public."FinanceRecord".id;
...
ALTER TABLE public."FinancialAccount_id_seq" OWNER TO postgres;
...
ALTER TABLE public."FinancialCategory_id_seq" OWNER TO postgres;
...
ALTER TABLE public."FinancialTransaction_id_seq" OWNER TO postgres;
...
ALTER TABLE public."GallerySale_id_seq" OWNER TO postgres;
...
ALTER TABLE public."InventoryItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."InventoryTransaction_id_seq" OWNER TO postgres;
...
ALTER TABLE public."PieceWorkDetail_id_seq" OWNER TO postgres;
...
ALTER TABLE public."PieceWorkItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."PieceWork_id_seq" OWNER TO postgres;
...
ALTER TABLE public."PosSaleItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."PosSale_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ProductTag_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ProductionBase_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ProductionOrderItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ProductionOrder_id_seq" OWNER TO postgres;
...
--
-- Name: PurchaseOrderApproval; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."PurchaseOrderApproval" OWNER TO postgres;

--
-- Name: PurchaseOrderImport; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."PurchaseOrderImport" (
    id integer NOT NULL,
...
ALTER TABLE public."PurchaseOrderImport" OWNER TO postgres;

--
-- Name: PurchaseOrderImport_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."PurchaseOrderImport_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."PurchaseOrderImport_id_seq" OWNER TO postgres;

--
-- Name: PurchaseOrderImport_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."PurchaseOrderImport_id_seq" OWNED BY public."PurchaseOrderImport".id;
...
ALTER TABLE public."PurchaseOrderItem_id_seq" OWNER TO postgres;
...
--
-- Name: PurchaseOrderReceiving; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."PurchaseOrderReceiving" (
    id integer NOT NULL,
    "purchaseOrderId" integer NOT NULL,
...
ALTER TABLE public."PurchaseOrderReceiving" OWNER TO postgres;

--
-- Name: PurchaseOrderReceivingItem; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."PurchaseOrderReceivingItem" (
    id integer NOT NULL,
    "receivingId" integer NOT NULL,
    "purchaseOrderItemId" integer NOT NULL,
    "expectedQuantity" integer NOT NULL,
    "receivedQuantity" integer NOT NULL,
    "qualityGrade" text DEFAULT 'A'::text NOT NULL,
    "qualityNotes" text,
...
ALTER TABLE public."PurchaseOrderReceivingItem" OWNER TO postgres;

--
-- Name: PurchaseOrderReceivingItem_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."PurchaseOrderReceivingItem_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."PurchaseOrderReceivingItem_id_seq" OWNER TO postgres;

--
-- Name: PurchaseOrderReceivingItem_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."PurchaseOrderReceivingItem_id_seq" OWNED BY public."PurchaseOrderReceivingItem".id;


--
-- Name: PurchaseOrderReceiving_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."PurchaseOrderReceiving_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."PurchaseOrderReceiving_id_seq" OWNER TO postgres;

--
-- Name: PurchaseOrderReceiving_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."PurchaseOrderReceiving_id_seq" OWNED BY public."PurchaseOrderReceiving".id;
...
ALTER TABLE public."PurchaseOrder_id_seq" OWNER TO postgres;
...
ALTER TABLE public."QualityRecord_id_seq" OWNER TO postgres;
...
ALTER TABLE public."SalaryAdjustment_id_seq" OWNER TO postgres;
...
ALTER TABLE public."SalaryRecord_id_seq" OWNER TO postgres;
...
ALTER TABLE public."SalesItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ScheduleTemplate_id_seq" OWNER TO postgres;
...
ALTER TABLE public."ShippingRecord_id_seq" OWNER TO postgres;
...
ALTER TABLE public."SystemAnnouncement_id_seq" OWNER TO postgres;
...
ALTER TABLE public."SystemLog_id_seq" OWNER TO postgres;
...
ALTER TABLE public."SystemMetrics_id_seq" OWNER TO postgres;
...
ALTER TABLE public."SystemSetting_id_seq" OWNER TO postgres;
...
ALTER TABLE public."UploadedFile_id_seq" OWNER TO postgres;
...
ALTER TABLE public."UserLoginHistory_id_seq" OWNER TO postgres;
...
ALTER TABLE public."WorkflowStep_id_seq" OWNER TO postgres;
...
ALTER TABLE public."WorkshopActivity_id_seq" OWNER TO postgres;
...
ALTER TABLE public."WorkshopPrice_id_seq" OWNER TO postgres;
...
ALTER TABLE public."WorkshopServiceItem_id_seq" OWNER TO postgres;
...
ALTER TABLE public."WorkshopTeamMember_id_seq" OWNER TO postgres;
...
--
-- Name: Artwork id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: ArtworkCategory id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ArtworkCategory" ALTER COLUMN id SET DEFAULT nextval('public."ArtworkCategory_id_seq"'::regclass);


--
-- Name: ArtworkTag id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ArtworkTag" ALTER COLUMN id SET DEFAULT nextval('public."ArtworkTag_id_seq"'::regclass);
...
--
-- Name: FinanceRecord id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."FinanceRecord" ALTER COLUMN id SET DEFAULT nextval('public."FinanceRecord_id_seq"'::regclass);
...
--
-- Name: PurchaseOrderImport id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderImport" ALTER COLUMN id SET DEFAULT nextval('public."PurchaseOrderImport_id_seq"'::regclass);
...
--
-- Name: PurchaseOrderReceiving id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceiving" ALTER COLUMN id SET DEFAULT nextval('public."PurchaseOrderReceiving_id_seq"'::regclass);


--
-- Name: PurchaseOrderReceivingItem id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceivingItem" ALTER COLUMN id SET DEFAULT nextval('public."PurchaseOrderReceivingItem_id_seq"'::regclass);
...
COPY public."Artwork" (id, name, price, "commissionRate", type, "createdAt", "updatedAt", description, "imageUrl", barcode, category, cost, sku, "categoryId", details, dimensions, "imageUrls", inventory, material, unit) FROM stdin;
\.


--
-- Data for Name: ArtworkCategory; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ArtworkCategory" (id, name, code, description, "imageUrl", "isActive", "sortOrder", "parentId", level, path, "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: ArtworkTag; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ArtworkTag" (id, name, color, description, "isActive", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: ArtworkTagsOnArtworks; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ArtworkTagsOnArtworks" ("artworkId", "tagId") FROM stdin;
\.
...
--
-- Data for Name: FinanceRecord; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."FinanceRecord" (id, type, amount, description, "referenceId", "referenceType", "supplierId", "productId", "accountId", "operatorId", "transactionDate", "dueDate", notes, status, "createdAt", "updatedAt") FROM stdin;
\.
...
1	34567	23	0	product	2025-06-28 02:10:42.168	2025-06-28 02:10:42.168	\N	/uploads/a5b2ecbc-d90c-4d79-aed0-7d610c5724dd.png	\N	\N	\N	\N	1	\N	\N	{/uploads/a5b2ecbc-d90c-4d79-aed0-7d610c5724dd.png}	3	珐琅	套
\.
...
1	45678	\N	\N	\N	t	0	\N	1	45678	2025-06-28 02:10:17.721	2025-06-28 02:10:17.721
\.
...
COPY public."PurchaseOrder" (id, "orderNumber", "supplierId", "employeeId", "orderDate", "expectedDate", status, "approvalStatus", "currentStep", "totalAmount", "paidAmount", "paymentStatus", "paymentMethod", notes, "importBatchId", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: PurchaseOrderApproval; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."PurchaseOrderApproval" (id, "purchaseOrderId", "workflowStepId", "approverId", "approverName", status, comments, "approvedAt", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: PurchaseOrderImport; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."PurchaseOrderImport" (id, "batchId", "fileName", "filePath", "importedBy", "totalRows", "successRows", "failedRows", status, "errorLog", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."PurchaseOrderItem" (id, "purchaseOrderId", "productId", "productName", quantity, price, "receivedQuantity", notes, "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: PurchaseOrderReceiving; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."PurchaseOrderReceiving" (id, "purchaseOrderId", "receivingNumber", "warehouseId", "receivedDate", "receivedBy", "receiverName", "totalReceived", "totalExpected", status, "qualityNotes", notes, "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: PurchaseOrderReceivingItem; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."PurchaseOrderReceivingItem" (id, "receivingId", "purchaseOrderItemId", "expectedQuantity", "receivedQuantity", "qualityGrade", "qualityNotes", "unitCost", notes, "createdAt", "updatedAt") FROM stdin;
\.
...
1	超级管理员	super_admin	系统超级管理员，拥有所有权限	t	2025-06-28 01:53:06.378	2025-06-28 01:53:06.378
\.
...
COPY public."Supplier" (id, name, "contactPerson", phone, email, address, description, "isActive", "supplierType", balance, "createdAt", "updatedAt") FROM stdin;
\.
...
1	a5b2ecbc-d90c-4d79-aed0-7d610c5724dd.png	WX20250515-222842@2x.png	/uploads/a5b2ecbc-d90c-4d79-aed0-7d610c5724dd.png	image/png	3805612	\N	2025-06-28 02:10:40.298	2025-06-28 02:10:40.298
\.
...
cmcfl6xsj00006wmfxvxvxk5q	超级管理员	admin@linghua.com	\N	\N	$2b$10$zRvCiNfdtfiqXn6uvRn63.nJdYV8NrctVa/kNYRzOd4PF18ZF3DOa	admin	2025-06-28 01:53:06.452	2025-06-28 02:09:29.897	\N	\N	2025-06-28 02:09:29.896	\N	\N	\N	{}	\N	0	\N
\.
...
1	cmcfl6xsj00006wmfxvxvxk5q	127.0.0.1	NextAuth-Credentials	2025-06-28 02:09:29.883	success	2025-06-28 02:09:29.884
\.
...
1	cmcfl6xsj00006wmfxvxvxk5q	1	2025-06-28 01:53:06.454	2025-06-28 01:53:06.454
\.
...
--
-- Name: ArtworkCategory_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."ArtworkCategory_id_seq"', 1, false);


--
-- Name: ArtworkTag_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."ArtworkTag_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."CoffeeShopPurchase_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."CoffeeShopSale_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."CoffeeShopShift_id_seq"', 1, false);
...
--
-- Name: FinanceRecord_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."FinanceRecord_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."FinancialAccount_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."ProductionBase_id_seq"', 1, false);
...
--
-- Name: PurchaseOrderImport_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."PurchaseOrderImport_id_seq"', 1, false);
...
--
-- Name: PurchaseOrderReceivingItem_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."PurchaseOrderReceivingItem_id_seq"', 1, false);


--
-- Name: PurchaseOrderReceiving_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."PurchaseOrderReceiving_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."SalaryRecord_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."SystemParameter_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."UploadedFile_id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."UserLoginHistory_id_seq"', 1, true);
...
--
-- Name: ArtworkCategory ArtworkCategory_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ArtworkCategory"
    ADD CONSTRAINT "ArtworkCategory_pkey" PRIMARY KEY (id);


--
-- Name: ArtworkTag ArtworkTag_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ArtworkTag"
    ADD CONSTRAINT "ArtworkTag_pkey" PRIMARY KEY (id);


--
-- Name: ArtworkTagsOnArtworks ArtworkTagsOnArtworks_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ArtworkTagsOnArtworks"
    ADD CONSTRAINT "ArtworkTagsOnArtworks_pkey" PRIMARY KEY ("artworkId", "tagId");
...
--
-- Name: FinanceRecord FinanceRecord_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: PurchaseOrderApproval PurchaseOrderApproval_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderApproval"
    ADD CONSTRAINT "PurchaseOrderApproval_pkey" PRIMARY KEY (id);


--
-- Name: PurchaseOrderImport PurchaseOrderImport_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderImport"
    ADD CONSTRAINT "PurchaseOrderImport_pkey" PRIMARY KEY (id);
...
--
-- Name: PurchaseOrderReceivingItem PurchaseOrderReceivingItem_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceivingItem"
    ADD CONSTRAINT "PurchaseOrderReceivingItem_pkey" PRIMARY KEY (id);


--
-- Name: PurchaseOrderReceiving PurchaseOrderReceiving_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceiving"
    ADD CONSTRAINT "PurchaseOrderReceiving_pkey" PRIMARY KEY (id);
...
--
-- Name: ArtworkTag_name_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "ArtworkTag_name_key" ON public."ArtworkTag" USING btree (name);
...
--
-- Name: FinanceRecord_referenceId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "FinanceRecord_referenceId_idx" ON public."FinanceRecord" USING btree ("referenceId");


--
-- Name: FinanceRecord_referenceType_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "FinanceRecord_referenceType_idx" ON public."FinanceRecord" USING btree ("referenceType");


--
-- Name: FinanceRecord_status_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: FinanceRecord_supplierId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "FinanceRecord_supplierId_idx" ON public."FinanceRecord" USING btree ("supplierId");


--
-- Name: FinanceRecord_transactionDate_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "FinanceRecord_transactionDate_idx" ON public."FinanceRecord" USING btree ("transactionDate");


--
-- Name: FinanceRecord_type_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "FinanceRecord_type_idx" ON public."FinanceRecord" USING btree (type);
...
--
-- Name: PurchaseOrderImport_batchId_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "PurchaseOrderImport_batchId_key" ON public."PurchaseOrderImport" USING btree ("batchId");


--
-- Name: PurchaseOrderReceiving_receivingNumber_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "PurchaseOrderReceiving_receivingNumber_key" ON public."PurchaseOrderReceiving" USING btree ("receivingNumber");
...
--
-- Name: ArtworkCategory ArtworkCategory_parentId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ArtworkCategory"
    ADD CONSTRAINT "ArtworkCategory_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES public."ArtworkCategory"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: ArtworkTagsOnArtworks ArtworkTagsOnArtworks_artworkId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ArtworkTagsOnArtworks"
    ADD CONSTRAINT "ArtworkTagsOnArtworks_artworkId_fkey" FOREIGN KEY ("artworkId") REFERENCES public."Artwork"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ArtworkTagsOnArtworks ArtworkTagsOnArtworks_tagId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ArtworkTagsOnArtworks"
    ADD CONSTRAINT "ArtworkTagsOnArtworks_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES public."ArtworkTag"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: Artwork Artwork_categoryId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Artwork"
    ADD CONSTRAINT "Artwork_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES public."ArtworkCategory"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public."ChannelSaleItem"
    ADD CONSTRAINT "ChannelSaleItem_productId_fkey" FOREIGN KEY ("productId") REFERENCES public."Product"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: FinanceRecord FinanceRecord_productId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."FinanceRecord"
    ADD CONSTRAINT "FinanceRecord_productId_fkey" FOREIGN KEY ("productId") REFERENCES public."Product"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: FinanceRecord FinanceRecord_supplierId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."FinanceRecord"
    ADD CONSTRAINT "FinanceRecord_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES public."Supplier"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public."PosSaleItem"
    ADD CONSTRAINT "PosSaleItem_productId_fkey" FOREIGN KEY ("productId") REFERENCES public."Product"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public."ProductionOrderItem"
    ADD CONSTRAINT "ProductionOrderItem_productId_fkey" FOREIGN KEY ("productId") REFERENCES public."Product"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: PurchaseOrderApproval PurchaseOrderApproval_approverId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderApproval"
    ADD CONSTRAINT "PurchaseOrderApproval_approverId_fkey" FOREIGN KEY ("approverId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: PurchaseOrderApproval PurchaseOrderApproval_purchaseOrderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderApproval"
    ADD CONSTRAINT "PurchaseOrderApproval_purchaseOrderId_fkey" FOREIGN KEY ("purchaseOrderId") REFERENCES public."PurchaseOrder"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: PurchaseOrderApproval PurchaseOrderApproval_workflowStepId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderApproval"
    ADD CONSTRAINT "PurchaseOrderApproval_workflowStepId_fkey" FOREIGN KEY ("workflowStepId") REFERENCES public."WorkflowStep"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: PurchaseOrderImport PurchaseOrderImport_importedBy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderImport"
    ADD CONSTRAINT "PurchaseOrderImport_importedBy_fkey" FOREIGN KEY ("importedBy") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: PurchaseOrderReceivingItem PurchaseOrderReceivingItem_purchaseOrderItemId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceivingItem"
    ADD CONSTRAINT "PurchaseOrderReceivingItem_purchaseOrderItemId_fkey" FOREIGN KEY ("purchaseOrderItemId") REFERENCES public."PurchaseOrderItem"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: PurchaseOrderReceivingItem PurchaseOrderReceivingItem_receivingId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceivingItem"
    ADD CONSTRAINT "PurchaseOrderReceivingItem_receivingId_fkey" FOREIGN KEY ("receivingId") REFERENCES public."PurchaseOrderReceiving"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: PurchaseOrderReceiving PurchaseOrderReceiving_purchaseOrderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceiving"
    ADD CONSTRAINT "PurchaseOrderReceiving_purchaseOrderId_fkey" FOREIGN KEY ("purchaseOrderId") REFERENCES public."PurchaseOrder"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: PurchaseOrderReceiving PurchaseOrderReceiving_receivedBy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceiving"
    ADD CONSTRAINT "PurchaseOrderReceiving_receivedBy_fkey" FOREIGN KEY ("receivedBy") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: PurchaseOrderReceiving PurchaseOrderReceiving_warehouseId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrderReceiving"
    ADD CONSTRAINT "PurchaseOrderReceiving_warehouseId_fkey" FOREIGN KEY ("warehouseId") REFERENCES public."Warehouse"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: PurchaseOrder PurchaseOrder_importBatchId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."PurchaseOrder"
    ADD CONSTRAINT "PurchaseOrder_importBatchId_fkey" FOREIGN KEY ("importBatchId") REFERENCES public."PurchaseOrderImport"("batchId") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public."SalesItem"
    ADD CONSTRAINT "SalesItem_productId_fkey" FOREIGN KEY ("productId") REFERENCES public."Product"(id) ON UPDATE CASCADE ON DELETE SET NULL;
