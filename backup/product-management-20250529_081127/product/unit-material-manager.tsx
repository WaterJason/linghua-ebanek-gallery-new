  ...
  return (
    <div className="space-y-4">
      ...
      <ConfirmDialog
        ...
        description={`确定要删除${deleteType === "unit" ? "单位" : "材质"} "${itemToDelete}" 吗？如果有产品使用此${deleteType === "unit" ? "单位" : "材质"}，可能会影响产品显示。`}
        confirmLabel="确认删除"
        variant="destructive"
